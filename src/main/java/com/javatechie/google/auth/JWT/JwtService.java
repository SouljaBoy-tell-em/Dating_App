package com.javatechie.google.auth.JWT;
...
//    @Value("${jwt.access.key}")
    public String JwtAccessKey = "53A73E5F1C4E0A2D3B5F2D784E6A1B423D6F247D1F6E5C3A596D635A75327855";
    ...
    public String GenerateTokenValue(UserDetails userDetails) {
        ...
        if(userDetails instanceof GoogleUser user) {
            additionalDataMap.put("role", UserRole.ROLE_USER);
        }
